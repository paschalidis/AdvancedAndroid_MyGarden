...
public class PlantWateringService extends IntentService {
    ...
    /**
     * Handle action  to update widgets in the provided background thread with the provided
     * parameters.
     */
    private void handleActionUpdatePlantWidgets() {
        ...
        if (cursor != null && cursor.getCount() > 0) {
            ...
            int plantTyoeIndex = cursor.getColumnIndex(PlantContract.PlantEntry.COLUMN_PLANT_TYPE);
            long timeNow = System.currentTimeMillis();
            long wateredAt = cursor.getLong(waterTimeIndex);
            long createdAt = cursor.getLong(createTimeIndex);
            int plantType = cursor.getInt(plantTyoeIndex);
            cursor.close();
        ...
        PlantWidgetProvider.onUpdatePlantWidgets(this, appWidgetManager, imgRes, appWidgetIds);
    }
}
